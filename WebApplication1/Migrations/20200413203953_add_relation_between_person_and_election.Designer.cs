...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20200413203953_add_relation_between_person_and_election")]
    partial class add_relation_between_person_and_election
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication1.Models.Voter", b =>
                {
                    b.HasOne("WebApplication1.Models.Candidate", null)
                        .WithMany("Voters")
                        .HasForeignKey("CandidateId");
                    ...
                    b.HasOne("WebApplication1.Models.Voter", null)
                        .WithMany("Voters")
                        .HasForeignKey("VoterId");
                });
